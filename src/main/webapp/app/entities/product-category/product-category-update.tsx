  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="petShopApp.productCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="petShopApp.productCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productCategoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="product-category-name">
                  <Translate contentKey="petShopApp.productCategory.name">Name</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="product-category-description">
                  <Translate contentKey="petShopApp.productCategory.description">Description</Translate>
                </Label>
