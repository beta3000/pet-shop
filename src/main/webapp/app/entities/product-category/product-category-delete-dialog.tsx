...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="petShopApp.productCategory.delete.question">
        <Translate contentKey="petShopApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
