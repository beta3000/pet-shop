...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_PETTYPE: 'petType/PARTIAL_UPDATE_PETTYPE',
...
export default (state: PetTypeState = initialState, action): PetTypeState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PETTYPE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PETTYPE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PETTYPE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IPetType> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_PETTYPE,
