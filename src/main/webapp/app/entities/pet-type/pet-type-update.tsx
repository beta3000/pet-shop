  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="petShopApp.petType.home.createOrEditLabel" data-cy="PetTypeCreateUpdateHeading">
            <Translate contentKey="petShopApp.petType.home.createOrEditLabel">Create or edit a PetType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
