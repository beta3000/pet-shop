...
import com.ciro.petshop.repository.ShoppingCartRepository;
import com.ciro.petshop.service.ShoppingCartService;
...
/**
 * REST controller for managing {@link com.ciro.petshop.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
